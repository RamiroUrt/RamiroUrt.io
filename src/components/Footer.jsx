...
<>
    <div id="ubicanos" className="p-15 flex justify-center m-[25px] py-0 text-lg flex-wrap xl:justify-between">
        ...
        <div className="max-w-[100%] flex flex-wrap justify-center flex-col items-center m-[2rem] text-gray-500 text-wrap text-xl text-center leading-[2.5rem]">
            <h2 className='flex overflow-hidden  font-bold leading-[3rem] md:leading-[7rem] text-primary '>SOBRE NOSOTROS</h2>
            <p className='flex overflow-hidden  '>Dirección: 123 Calle Principal, Ciudad, País</p>
            <p className='flex overflow-hidden  '>Email: info@bikeshop.com</p>
            <p className='flex overflow-hidden  '>Teléfono: +123 456 789</p>
        </div>
        <div className="max-w-[100%] flex flex-wrap justify-center flex-col items-center overflow-hidden m-[2rem] text-xl text-center pt-0 mt-0 leading-[3rem]">
