...
<>
    <div id="ubicanos" className="p-15 flex justify-center m-[25px] py-0 text-lg flex-wrap xl:justify-between">
        ...
        <div className="max-w-[100%] flex flex-wrap justify-center flex-col  m-[2rem]  text-gray-500 text-xl leading-[2.5rem]">
        ...
        <div className="max-w-[100%] flex flex-wrap justify-center flex-col items-center overflow-hidden m-[2rem]">
            <h2 className='flex overflow-hidden flex-wrap break-all  font-bold leading-[3rem] md:leading-[7rem] text-primary'>SIGUENOS</h2>
